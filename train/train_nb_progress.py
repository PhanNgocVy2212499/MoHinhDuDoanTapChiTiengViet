...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train baseline Multinomial Naive Bayes voi hien thi tien do terminal"
    )
    parser.add_argument("--csv", type=str, default="dataset_tapchi.csv")
    parser.add_argument("--save-cm", type=str, default="confusion_matrix_nb.png")
    parser.add_argument(
        "--show-plot",
        action="store_true",
...
def main() -> None:
    ...
    # 5) Train Naive Bayes
    log_step(5, total_steps, "Huấn luyện mo hinh MultinomialNB")
    model = MultinomialNB()
    ...
    print("\n" + "=" * 70)
    print("KET QUA BASELINE - MULTINOMIAL NAIVE BAYES")
    print("=" * 70)
    ...
    plt.title("Ma tran nham lan - Baseline Multinomial Naive Bayes", fontsize=13)
