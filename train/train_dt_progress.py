...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train Decision Tree voi hien thi tien do terminal"
    )
    parser.add_argument("--csv", type=str, default="dataset_tapchi.csv")
    parser.add_argument("--save-cm", type=str, default="confusion_matrix_dt.png")
    parser.add_argument(
        "--show-plot",
        action="store_true",
...
def main() -> None:
    ...
    log_step(5, total_steps, "Huấn luyện mo hinh Decision Tree")
    ...
    print("\n" + "=" * 70)
    print("KET QUA BASELINE - DECISION TREE")
    print("=" * 70)
    ...
    plt.title("Ma tran nham lan - Baseline Decision Tree", fontsize=13)
